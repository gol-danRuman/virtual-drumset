...
import pygame
from drumset_flask_api.roi_location import ROI
import sys
import pygame,time
...
HI = pygame.mixer.Sound('music_samples/HiHats1/hihat23.wav')
snare = pygame.mixer.Sound('music_samples/SnareDrums1/snaredrum1.wav')
KD = pygame.mixer.Sound('music_samples/KickDrums1/kickdrum11.wav')
bass = pygame.mixer.Sound('music_samples/Cymbals2/cymbalcrash1.wav')
...
class DrumSet:
    ...
    def getFrame( frame):
        ...
        hsv = cv2.cvtColor(frame, cv2.CV_RGB2HSV)
